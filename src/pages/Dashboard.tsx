    ...
    <TooltipProvider>
      <div className="space-y-8 animate-fade-in relative">
        ...
        <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
          <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-gradient-to-r from-blue-400/5 to-purple-600/5 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-gradient-to-r from-emerald-400/5 to-cyan-600/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
        </div>

        {/* Enhanced Hero Header Section */}
        <div className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-slate-900 dark:via-blue-900/20 dark:to-purple-900/20 rounded-3xl p-8 border border-blue-100 dark:border-slate-700 shadow-2xl hover:shadow-3xl transition-all duration-500 z-10">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-emerald-400/10 to-blue-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '3s' }}></div>
          
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center space-x-6 animate-fade-in">
                <div className="p-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-3xl shadow-xl hover:scale-110 transition-transform duration-300">
                  <Activity className="w-10 h-10 text-white" />
                </div>
                <div>
                  <h1 className="text-5xl font-bold bg-gradient-to-r from-slate-900 via-blue-800 to-purple-800 dark:from-white dark:via-blue-200 dark:to-purple-200 bg-clip-text text-transparent animate-fade-in">
                    🚀 Market Command Center
                  </h1>
                  <p className="text-xl text-slate-600 dark:text-slate-300 animate-fade-in" style={{ animationDelay: '0.2s' }}>
                    Real-time AI insights driving your investment success
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                <Badge className="bg-gradient-to-r from-emerald-50 to-blue-50 dark:from-emerald-950/20 dark:to-blue-950/20 border-emerald-200 dark:border-emerald-800 hover:scale-105 transition-transform duration-200">
            ...
            <div className="flex items-center justify-between mb-8 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                { icon: TrendingUp, label: 'Market Sentiment', value: '🔥 Bullish +73%', color: 'text-emerald-500', bgColor: 'from-emerald-500/10 to-green-500/10', tooltip: 'Overall market sentiment based on AI analysis of 10,000+ news sources' },
                { icon: Users, label: 'Active Signals', value: '2,847 📈', color: 'text-blue-500', bgColor: 'from-blue-500/10 to-cyan-500/10', tooltip: 'Number of active trading signals generated by our AI' },
                { icon: Shield, label: 'Accuracy Score', value: '⭐ 94.7%', color: 'text-purple-500', bgColor: 'from-purple-500/10 to-pink-500/10', tooltip: 'AI prediction accuracy over the last 30 days' },
                { icon: Zap, label: 'Processing Speed', value: '⚡ 8ms', color: 'text-amber-500', bgColor: 'from-amber-500/10 to-orange-500/10', tooltip: 'Average time to process and analyze new market data' }
              ].map((stat, index) => (
                <Tooltip key={stat.label}>
                  <TooltipTrigger asChild>
                    <div className={`group cursor-help bg-gradient-to-br ${stat.bgColor} backdrop-blur-sm rounded-2xl p-6 border border-white/30 dark:border-slate-600/30 hover:bg-white/80 dark:hover:bg-slate-800/60 transition-all duration-500 hover:scale-110 hover:shadow-2xl animate-fade-in`} style={{ animationDelay: `${index * 0.1}s` }}>
                      <div className="flex items-center space-x-4">
                        <div className={`p-3 bg-gradient-to-r ${stat.color === 'text-emerald-500' ? 'from-emerald-500 to-green-600' : stat.color === 'text-blue-500' ? 'from-blue-500 to-cyan-600' : stat.color === 'text-purple-500' ? 'from-purple-500 to-pink-600' : 'from-amber-500 to-orange-600'} rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="space-y-6 animate-fade-in" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={card.title} className={`group hover:scale-105 transition-all duration-500 animate-fade-in`} style={{ animationDelay: `${index * 0.1}s` }}>
                <div className={`p-6 bg-gradient-to-br ${card.gradient} backdrop-blur-sm rounded-2xl border border-white/30 dark:border-slate-700/30 hover:shadow-2xl transition-all duration-500`}>
                  <SentimentCard
                    title={card.title}
                    value={card.value}
                    change={card.change}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-fade-in" style={{ animationDelay: '0.6s' }}>
          <div className="lg:col-span-2 space-y-8">
            <div className="group hover:scale-[1.02] transition-all duration-500 hover:shadow-2xl">
              <SentimentChart />
            </div>
            <div className="group hover:scale-[1.02] transition-all duration-500 hover:shadow-2xl">
              <HeatmapView />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-fade-in" style={{ animationDelay: '0.8s' }}>
          {/* Enhanced Top Performers */}
          <div className="bg-gradient-to-br from-white via-green-50/50 to-emerald-50/30 dark:from-slate-800 dark:via-green-900/10 dark:to-emerald-900/20 p-8 rounded-3xl border border-green-100 dark:border-slate-700 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] group">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center space-x-4">
                <div className="p-3 bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="space-y-4">
              {['AAPL', 'MSFT', 'GOOGL', 'TSLA'].map((ticker, index) => (
                <div key={ticker} className={`group/item flex items-center justify-between p-4 bg-white/80 dark:bg-slate-700/50 rounded-2xl border border-white/50 dark:border-slate-600/50 hover:bg-white dark:hover:bg-slate-700/80 transition-all duration-300 cursor-pointer hover:scale-105 hover:shadow-lg animate-fade-in`} style={{ animationDelay: `${index * 0.1}s` }}>
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg group-hover/item:scale-110 transition-transform duration-300">
          ...
          <div className="bg-gradient-to-br from-white via-purple-50/50 to-blue-50/30 dark:from-slate-800 dark:via-purple-900/10 dark:to-blue-900/20 p-8 rounded-3xl border border-purple-100 dark:border-slate-700 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] group">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center space-x-4">
                <div className="p-3 bg-gradient-to-r from-purple-500 to-blue-600 rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={item.label} className={`space-y-3 animate-fade-in`} style={{ animationDelay: `${index * 0.2}s` }}>
                  <div className="flex items-center justify-between">

  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-6xl mx-auto p-6 space-y-6">
        {/* Enhanced Pixel Header */}
        <div className="text-center space-y-4">
          <div className="flex items-center justify-center space-x-3 mb-4">
            <div className="p-3 bg-gradient-to-r from-pixel-green/20 to-pixel-cyan/20 rounded-lg pixel-glow">
              <Newspaper className="w-8 h-8 text-pixel-green" />
            </div>
            <div>
              <h1 className="text-4xl font-bold gradient-text font-pixel">
          ...
          <div className="flex items-center justify-center space-x-4">
            <Button
              ...
              variant="outline"
              size="sm"
              className={`${autoRefresh ? 'text-pixel-green border-pixel-green bg-pixel-green/10 hover:bg-pixel-green/20' : 'text-muted-foreground hover:bg-secondary'} transition-all duration-200 font-pixel shadow-sm`}
            >
            ...
            <Button
              ...
              className="transition-all duration-200 font-pixel shadow-sm hover:shadow-md pixel-button"
            >
            ...
            <div className="flex items-center space-x-2 text-sm text-muted-foreground">
              <TrendingUp className="w-4 h-4 text-pixel-cyan" />
              <span className="font-pixel">{filteredNews.length} ARTICLES</span>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6 pr-4">
              {filteredNews.length === 0 ? (
                ...
                filteredNews.map((item, index) => (
                  <Card 
                    key={item.id} 
                    className="news-card border hover:pixel-glow hover:scale-[1.02] transition-all duration-300 cursor-pointer shadow-lg animate-slide-in-pixel"
